...
public class Test1 extends BaseTest {
    public static void openLoginPopup() {
        ...
        Assert.assertEquals(titlePopUp, "Вход", "The title of the pop-up is not 'Вход'");
    }
    ...
    public void positiveCheckLoginPopup(String email, String password) {
        ...
        Assert.assertTrue(driver.findElement(By.xpath("//div[@class=\"modal__holder modal__holder_show_animation modal__holder--medium\"]")).isDisplayed(),
